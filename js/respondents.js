...
function draw_radio_button(posX, posY, page_num){
	...
	var htmlData='<div id="radbtn'+$.count+'" class="radiosnap static_obj" ' + 'data-page="' + $.page + '" ';
	if (posX !== null && posY !== null){
	...
	htmlData += '><input type="radio" id="radeditable'+$.count+'" name="'+$.page+'" value="radiobutton"><div class="default" style="width:100%; height:100%; display:inline; vertical-align:middle">Radio Button</div></div>';

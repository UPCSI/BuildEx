...
COPY "Experiments" (eid, title, category, target_count, current_count, status, request_status, description, is_published, path) FROM stdin;
\.
...
COPY "Graduates" (uid, gid, student_num) FROM stdin;
7	4	\N
\.
...
4	admin	$6$rounds=10000$iNt3ll3Q$vL7JO/sjCHyaL6HLfT3217UDZbvV5dTbGCPdDLYvzzQ73xyo362LP0dbZ6I2QUu29YvLCvfnlSmYApJq0DlFa/	administrator	earl	bunao		\N
7	gardevior411	$6$rounds=10000$iNt3ll3Q$vL7JO/sjCHyaL6HLfT3217UDZbvV5dTbGCPdDLYvzzQ73xyo362LP0dbZ6I2QUu29YvLCvfnlSmYApJq0DlFa/	larssen	.	bunao	gardevior_erb411@yahoo.com	\N
\.
...
SELECT pg_catalog.setval('graduates_gid_seq', 4, true);
...
COPY member_of (uid, labid, since) FROM stdin;
\.
...
SELECT pg_catalog.setval('users_uid_seq', 7, true);

<?php echo form_open('admins/create'); ?>
    <div class="row">
        <div class="large-4 columns">
            ...
            <input type="text" id="signUpFName" required name="first_name" placeholder="First Name">
        </div>
        <div class="large-4 columns">
            <label>Middle Name</label>
            <input type="text" id="signUpMName" required name="middle_name" placeholder="Middle Name">
        </div>
        <div class="large-4 columns">
            <label>Last Name</label>
            <input type="text" id="signUpLName" required name="last_name" placeholder="Last Name">
        </div>
    </div>

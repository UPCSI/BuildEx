...
<p> <strong> Current Count: </strong><?php echo $experiment->current_count; ?> (<a href = "<?php echo site_url('experiment/respondents/'.$experiment->eid); ?>"> View All </a> ) </p>
...
<?php else: ?>
	<p> <strong> URL: </strong> <a href ="<?php echo site_url('respond/'.$experiment->url); ?>"> <?php echo site_url('respond/'.$experiment->url); ?> </a></p>
